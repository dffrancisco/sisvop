...
class executa
{
    ...
    //    public static function insertUpdateFireBird($conexao, $nameTabela, $param, $printSQL = false){
    //        'update or insert into agenda
    //        (id_agenda, cod_funcionario, nome, telefone)
    //        values
    //        (:id_agenda, :cod_funcionario, :nome, :telefone)
    //        matching
    //        (id_agenda)';
